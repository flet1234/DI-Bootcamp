...
interface BoolChack <T> {
    value: T,
    is: boolean
}

const checkBool = <T>(arg:T): BoolChack<T> => {
...
const username2 = new StateObject<number>(123)
username2.state = 345
...
type Passed = Exclude<Grades,'C'>

// Extract 

type Failed = Extract<Grades, 'C'>

// NonNullable

type Nullable = string | null | undefined

type NoNullableString = NonNullable<Nullable>
...
const usernew: UserReturnType = {name:'John',age:24}
