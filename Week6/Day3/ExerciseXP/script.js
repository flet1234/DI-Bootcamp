...
// it will be Text about person, that uses data from person object
// ---------------------------------------------------------------------------
...
// let newArray=array.map(([key,value]) => {
//     return [key,value*2]})
...
// Object, everithing in js is an object
// -------------------------------------------------------------------------
...
// const object3 = object2;  4 we reasign object 1 number and now by reference its 4 for other objects
...
//     }  
//     sound(sound){
//         return `${this.color} ${this.type} ${this.name} make a sound: ${sound}`
//     }
// }   
