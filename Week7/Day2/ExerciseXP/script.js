...
// let url='https://api.giphy.com/v1/gifs/search?q=creepy&rating=r&api_key=hpvZycW22qCjn5cRM1xtWB8NKq4dQ2My'
...
// let url='https://api.giphy.com/v1/gifs/search?q=sun&limit=10&offset=2&api_key=hpvZycW22qCjn5cRM1xtWB8NKq4dQ2My'

// async function getSun(url){
//     try {
//         res=await fetch(url)
//         if (res.status == 200){
//             data=await res.json()
